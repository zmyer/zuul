...
public abstract class BaseZuulChannelInitializer extends ChannelInitializer<Channel> {
    ...
    public static final CachedDynamicIntProperty MAX_INITIAL_LINE_LENGTH = new CachedDynamicIntProperty(
    ...
    protected BaseZuulChannelInitializer(
        ...
        PerEventLoopMetricsChannelHandler perEventLoopMetricsHandler = new PerEventLoopMetricsChannelHandler(
        ...
        this.rateLimitingChannelHandler = channelDependencies.get(ZuulDependencyKeys.rateLimitingChannelHandlerProvider)
                .get();
    ...
    protected void addHttp1Handlers(ChannelPipeline pipeline) {
        ...
        pipeline.addLast("conn_expiry_handler",
                new Http1ConnectionExpiryHandler(maxRequestsPerConnection, maxRequestsPerConnectionInBrownout,
                        connectionExpiry));
    }
